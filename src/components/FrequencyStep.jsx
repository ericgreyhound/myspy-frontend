...
const OPTIONS = ['Raramente', 'Algumas vezes por mês', 'Semanalmente', 'Quase todos os dias'];

export default function FrequencyStep({ theme, value = '', onNext }) {
  ...
  return (
    <div className="mt-4 pb-8">
      ...
      >
        Com que frequência sai para comer?
      </h2>

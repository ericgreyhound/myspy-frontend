...
const OPTIONS = ['Família', 'Amigos', 'Lazer', 'Trabalho', 'Clientes', 'Não cozinho em casa'];

export default function MotivationStep({ theme, value = [], onNext }) {
